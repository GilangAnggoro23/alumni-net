...
if (isset($_POST['post_register'])) {
  ...
  if ($nama_lengkap == '' || $username == '' || $password == '' || $konfirm_password == '') {
    echo ('<script>alert("Inputan harus di isi ")</script>');
  }
  if ($password != $konfirm_password) {
    echo ('<script>alert("Password tidak sama")</script>');
  }

  $insert = mysqli_query($koneksi, "insert into user (id,nama_lengkap,username,password) values('','$nama_lengkap','$username','$password')");
          ...
          <div class="wadah_icon_login">
            ...
            <div class="wadah_form_login_1">
              <form method="post" action="">
                <input type="hidden" name="post_register">
                ...
                <button class="button_form_login" type="submit">
                  Daftar
                </button>
